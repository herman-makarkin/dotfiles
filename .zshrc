...
if [[ ":$FPATH:" != *":/home/godfather/.zsh/completions:"* ]]; then export FPATH="/home/godfather/.zsh/completions:$FPATH"; fi
...
#plugins=(git aliases gitfast autojump zsh-autosuggestions sudo)
